...
class InteractiveShapeOverlay extends StatefulWidget {
  final ShapeType type;
  final VoidCallback onCancel;
  final Function(Offset position, Size size) onConfirm;

  const InteractiveShapeOverlay({
    super.key,
    required this.type,
  ...
  @override
  State<InteractiveShapeOverlay> createState() => _InteractiveShapeOverlayState();
}

class _InteractiveShapeOverlayState extends State<InteractiveShapeOverlay> {
