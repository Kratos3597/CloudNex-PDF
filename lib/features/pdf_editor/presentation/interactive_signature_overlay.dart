...
class InteractiveSignatureOverlay extends StatefulWidget {
  final Uint8List imageBytes;
  final VoidCallback onCancel;
  final Function(Offset position, Size size) onConfirm;

  const InteractiveSignatureOverlay({
    super.key,
  ...
  @override
  State<InteractiveSignatureOverlay> createState() => _InteractiveSignatureOverlayState();
}

class _InteractiveSignatureOverlayState extends State<InteractiveSignatureOverlay> {
