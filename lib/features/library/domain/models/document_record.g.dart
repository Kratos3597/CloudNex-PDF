...
const DocumentRecordSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'lastZoomLevel': PropertySchema(
      id: 5,
      name: r'lastZoomLevel',
...
void _documentRecordSerialize(
  ...
  writer.writeLong(offsets[4], object.lastOpenedPage);
  writer.writeDouble(offsets[5], object.lastZoomLevel);
...
DocumentRecord _documentRecordDeserialize(
  ...
  object.lastOpenedDate = reader.readDateTime(offsets[3]);
  object.lastOpenedPage = reader.readLong(offsets[4]);
  object.lastZoomLevel = reader.readDouble(offsets[5]);
...
extension DocumentRecordQueryFilter
  ...
  QueryBuilder<DocumentRecord, DocumentRecord, QAfterFilterCondition>
      lastZoomLevelEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastZoomLevel',
        value: value,
        epsilon: epsilon,
      ));
    });
...
extension DocumentRecordQuerySortBy
  ...
  QueryBuilder<DocumentRecord, DocumentRecord, QAfterSortBy>
      sortByLastZoomLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastZoomLevel', Sort.asc);
    });
  }

  QueryBuilder<DocumentRecord, DocumentRecord, QAfterSortBy>
      sortByLastZoomLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastZoomLevel', Sort.desc);
    });
  }

  QueryBuilder<DocumentRecord, DocumentRecord, QAfterSortBy> sortBySummary() {
    return QueryBuilder.apply(this, (query) {
...
extension DocumentRecordQuerySortThenBy
  ...
  QueryBuilder<DocumentRecord, DocumentRecord, QAfterSortBy>
      thenByLastZoomLevelDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastZoomLevel', Sort.desc);
    });
  }

  QueryBuilder<DocumentRecord, DocumentRecord, QAfterSortBy> thenBySummary() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'summary', Sort.asc);
    });
  }
...
extension DocumentRecordQueryWhereDistinct
  ...
  QueryBuilder<DocumentRecord, DocumentRecord, QDistinct>
      distinctByLastZoomLevel() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastZoomLevel');
    });
  }

  QueryBuilder<DocumentRecord, DocumentRecord, QDistinct> distinctBySummary(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentRecord, DocumentRecord, QDistinct> distinctByTags() {
    return QueryBuilder.apply(this, (query) {
...
extension DocumentRecordQueryProperty
  ...
  QueryBuilder<DocumentRecord, bool, QQueryOperations> isFavoriteProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DocumentRecord, double, QQueryOperations>
      lastZoomLevelProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastZoomLevel');
    });
  }

  QueryBuilder<DocumentRecord, String?, QQueryOperations> summaryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'summary');
    });
  }

  QueryBuilder<DocumentRecord, List<String>?, QQueryOperations> tagsProperty() {
    return QueryBuilder.apply(this, (query) {
